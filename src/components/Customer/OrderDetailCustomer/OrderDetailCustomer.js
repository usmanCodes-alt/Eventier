            ...
            <div className="row">
              <div className=" col-lg-7 col-md-7 col-sm-7 orderdetailcardLeftCustomer  ">
                ...
                <div className="detail_ordercustomer">
                  <label className="label_order_informationcustomer">Customer Name :&nbsp; </label>
                  <label >{formValues.customer_fname}  &nbsp; {formValues.customer_lname}</label>
                </div>
                <div className="detail_ordercustomer">
                  <label className="label_order_informationcustomer">Payment_status : &nbsp; </label>
                  <label >{formValues.payment_status}</label>
                </div>
                <div className="detail_ordercustomer">
                  <label className="label_order_informationcustomer">Service Provider Name : &nbsp; </label>
                  <label >{formValues.service_provider_fname} &nbsp; {formValues.service_provider_lname}</label>
                </div>
                <div className="detail_ordercustomer">
                  <label className="label_order_informationcustomer">Service Provider Email : &nbsp; </label>
                  <label >{formValues.service_provider_email}</label>
                </div>
                <div className="detail_ordercustomer">
                  <label className="label_order_informationcustomer">Service Provider PNo : &nbsp; </label>
              ...
              <div className=" col-lg-4 col-md-4 col-sm-4    ">
                <div className="row orderdetailcardRightCustomer">
                  <label className="label_order_informationcustomer">Order Status</label>
                  <div>
                  <img src={Image2}    />
                  </div>
                ...
                <div className="row orderdetailcardRightCustomer">
                <label className="label_order_informationcustomer">Seller information</label>
                  <div>
                  <img src={Image3}    />
                  </div>
                  <div className="status_ordercustomer">
                    <label className="label_order_informationcustomer">Name : &nbsp; </label>
                    <label >{formValues.customer_fname} &nbsp; {formValues.customer_lname}  </label>
                  </div>
                  <div className="status_ordercustomer">
                    <label className="label_order_informationcustomer">Email : &nbsp; </label>
