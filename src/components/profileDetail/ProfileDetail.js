...
<div className="container-fluid profileDetail">
  <div className="row">
                  ...
                  <div className="col-sm-8">
                    <div className="card-block">
                      ...
                      <div className="row">
                        ...
                        <button type="button" className="btn btn-dark btndetail" onClick={handleUpdate}>
                          Update
                        </button>
                      </div>
                    </div>
    ...
    <div className='col-lg-4 col-md-4 col-sm-4 cardleftMost'>
      ...
      <input type="password" className="form-control" name="oldpass" placeholder="Old Password" value={password.oldpass}
        onChange={handleChange} />
      <p>{formErrors.oldpass}</p>

      <label>New Password</label>
      <input type="password" className="form-control" name="newpass" placeholder="New Password" value={password.newpass}
        onChange={handleChange} />
      <p>{formErrors.newpass}</p>

      <label>Confirm New Password</label>
      <input type="password" className="form-control" name="cnfrmpass" placeholder="Confirm New Password"
        value={password.cnfrmpass} onChange={handleChange} />
      <p>{formErrors.cnfrmpass}</p>
      <button type="button" className="btn btn-dark btndetail" onClick={handleSubmit}>
        Update Password
      </button>
